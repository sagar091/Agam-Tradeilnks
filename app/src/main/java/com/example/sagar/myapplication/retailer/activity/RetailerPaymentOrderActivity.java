...
public class RetailerPaymentOrderActivity extends AppCompatActivity {
    ...
    private class GetOrderDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = ProgressDialog.show(RetailerPaymentOrderActivity.this, "Loading", "Please wait..", false);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            pd.dismiss();
            if (orderError.equals("0")) {
                adapter = new MyAdapter(RetailerPaymentOrderActivity.this, model.orders);
